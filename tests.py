...
class TestMethods(unittest.TestCase):
    ...
    sample_data = [
        ('Natalie', 'Wetta', 'abc@gmail.com', 'male', 'Turkey','603-679-1010', '1333-04-05', '376543576978', 'EUR', True, 'acc_type1'),
        ('Thomy', 'Kessler','def@gmail.com', 'female', 'United States', '603-679-5671', '1333-04-05','312563478', 'EUR', True, 'acc_type3'),
        ('Melissa', 'McQueen','ghi@gmail.com', 'male', 'Spain', '603-679-1978', '1333-04-05', '3364069796', 'EUR', False, 'acc_type9'),
        ('Rich', 'Sommer', 'jkl@gmail.com', 'male', 'Poland', '603-679-3186','1333-04-05','9764131867', 'UAH', True, 'acc_type9'),
        ('Finn', 'Wittrock','mno@gmail.com', 'female', 'Russia', '548-787-4519', '1333-04-05','273979677', 'RUB', False, 'acc_type1'),
